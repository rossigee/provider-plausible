...
- **Primary**: `ghcr.io/rossigee/provider-plausible:v0.4.4`
...
```bash
kubectl crossplane install provider ghcr.io/rossigee/provider-plausible:v0.4.4
```
...
spec:
  package: ghcr.io/rossigee/provider-plausible:v0.4.4
```
