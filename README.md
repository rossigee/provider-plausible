...
- **Primary**: `ghcr.io/rossigee/provider-plausible:v0.4.5`
...
```bash
kubectl crossplane install provider ghcr.io/rossigee/provider-plausible:v0.4.5
```
...
spec:
  package: ghcr.io/rossigee/provider-plausible:v0.4.5
```
