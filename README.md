...
- **Primary**: `ghcr.io/rossigee/provider-plausible:v0.4.1`
...
```bash
kubectl crossplane install provider ghcr.io/rossigee/provider-plausible:v0.4.1
```
...
spec:
  package: ghcr.io/rossigee/provider-plausible:v0.4.1
```
